...
class ConfirmationChequeController extends AppController {
    ...
    public function ajoutOperation() {
        ...
        $allowedToAdd = in_array($user['privilege'], ['Agence', 'AgenceSage', 'Caissiere', 'CaissiereLD', 'CaissiereSage']);
        if (!$allowedToAdd) {
            echo json_encode([
                'success' => false,
    ...
    public function updateOperation() {
        ...
        $allowedToEdit = in_array($user['privilege'], ['Agence', 'AgenceSage', 'Caissiere', 'CaissiereLD', 'CaissiereSage']);
        if (!$allowedToEdit) {
            echo json_encode([
                'success' => false,
    ...
    private function generateOperationRowHtml($operation, $user) {
        ...
        $allowedToAdd = in_array($userPrivilege, ['Agence', 'AgenceSage', 'Caissiere', 'CaissiereLD', 'CaissiereSage']);
